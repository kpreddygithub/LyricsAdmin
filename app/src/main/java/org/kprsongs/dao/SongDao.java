...
public class SongDao extends AbstractDao {
    ...
    public long insertSong(String title, String entireSong, String alternate_title, String search_title, String search_lyrics, String comments) {
        ContentValues contenValues = new ContentValues();
//        "title", "lyrics", "verse_order", "search_title", "search_lyrics", "comments"
        contenValues.put("title", title);
        contenValues.put("lyrics", entireSong);
        contenValues.put("alternate_title", alternate_title);
        contenValues.put("search_title", search_title);
        contenValues.put("search_lyrics", search_lyrics);
